...
class EXISTS_AS_FOREIGN_SIM {

     static final Logger logger = LogManager.getLogger(EXISTS_AS_FOREIGN_SIM.class);

     static String executeRule(String[] args, Connection conn) {
          try {

                if (!(((args[12].trim().startsWith("19") || args[12].trim().startsWith("00")) 
                        ? args[12].substring(2) : args[12])).startsWith("855") 
