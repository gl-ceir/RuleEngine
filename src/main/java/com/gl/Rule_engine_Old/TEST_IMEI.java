            ...
            switch (args[13]) {
                ...
                case "Report": {
                    ...
                    try (Statement stmt = conn.createStatement();) {
                        ...
                        String qur = " insert into test_imei_details  (imei ,IMSI,  msisdn , record_type , system_type , source,raw_cdr_file_name,imei_arrivalTime ,operator, file_name , created_on , modified_on    )  values "
