 ...
 * @author user
 */
public class SAME_SERIAL_UNBLOCK implements  RuleEngineInterface{
...
//            logger.info("   111");
//            if (ruleEngine.sNofDevice == null) {
//                logger.info(" !! ruleEngine.sNofDevice.toString() == null ");
//            }
//
//            logger.info("   3333");
//            if (ruleEngine.sNofDevice == "null") {
//                logger.info(" !! ruleEngine.sNofDevice.toString()  == BRAckedNull ");
//            }
//            logger.info("   222 ");
//            if (ruleEngine.sNofDevice.equals("null")) {
//                logger.info(" !! ruleEngine.sNofDevice.toString().equals(null) ");
//            }

            logger.info(" !! " + opr1 + " ##  " + ruleEngine.sNofDevice);
        ...
        try {
            switch (ruleEngine.action) {
                ...
                case "Reject": {
                    ...
                    String fileString = ruleEngine.fileArray + ",Error Code :CON_RULE_0032 , Error Description : Device serial number does not match with value provided at the time of blocking  ";
