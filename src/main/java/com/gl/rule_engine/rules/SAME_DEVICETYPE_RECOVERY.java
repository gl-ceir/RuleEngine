 ...
 * @author user
 */
public class SAME_DEVICETYPE_RECOVERY implements  RuleEngineInterface{
        ...
        try {
            switch (ruleEngine.action) {
                ...
                case "Reject": {
                    ...
                    String fileString = ruleEngine.fileArray + ",Error Code :CON_RULE_0032 , Error Description : Device Type does not match with value provided at the time of Stolen  ";
